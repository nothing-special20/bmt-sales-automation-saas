"""
Django settings for Automated Follow-ups for Landscaping Businesses project.
...
SECRET_KEY = 'tfAbKDApmmUCmFBMNRbnjzscscVFShXaYLJXpyut'
...
PROJECT_APPS = [
    ...
    'apps.web',
    'apps.follow_up.apps.FollowUpConfig',
]
...
ROOT_URLCONF = 'bmt_sales_automation.urls'
...
WSGI_APPLICATION = 'bmt_sales_automation.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_DATABASE_NAME', 'bmt_sales_automation'),
